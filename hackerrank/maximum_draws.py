...
case scenario, how many socks (x) should Jim remove from his drawer until he
finds a matching pair?

Input Format
The first line contains the number of test cases T.
Next T lines contains an integer N which indicates the total pairs of socks
...
Explanation
Case 1 : A pair of socks are present, hence exactly 2 draws for the socks
to match.
...
assert maximumDraws(1) == 2
assert maximumDraws(2) == 3
